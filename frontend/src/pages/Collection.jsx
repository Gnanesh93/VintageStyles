...
const Collection = () => {
  ...
  // Read URL query params and apply auto-filter
  useEffect(() => {
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      <div className='min-w-60'>
        ...
        <div className={`border border-gray-300 pl-5 my-3 ${showFilter? "":'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value="Topwear" checked={subCategory.includes("Topwear")} onChange={(toggleSubCategory)}/>Top wear
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value="Bottomwear" checked={subCategory.includes("Bottomwear")} onChange={(toggleSubCategory)}/>Bottom wear
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value="Winterwear" checked={subCategory.includes("Winterwear")} onChange={(toggleSubCategory)}/>Winter wear
            </p>
          </div>
        </div>
      </div>
