...
const productTypeOptions={
  Men:{
    Topwear:["Shirt","TShirt","Sherwani","Suit"],
    Bottomwear:["Jeans","Pants","Shorts","Trousers"],
    Winterwear:["Sweater","Jacket","Hoodie"]
  },
  Women:{
    Topwear:["Kurti","TShirt","Blouse"],
    Bottomwear:["Jeans","Skirt","Leggings"],
    Winterwear:["Sweater","Cardigan","Jacket"],
    Ethnicwear:["Saree","Lehenga","Dress"]
  },
  Kids:{
    Topwear:["KidBoyShirt","KidGirlTop"],
    Bottomwear:["KidBoyShorts","KidGirlSkirt"],
    Winterwear:["KidSweater","KidJacket"],
    Ethnicwear:["KidGirlGown","KidGirlDress"]
  }
};
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          <select className='w-full px-3 py-2' value={category} onChange={(e) => {
        ...
        <div>
          ...
          <select className='w-full px-3 py-2' value={subCategory} onChange={(e) => {
            setSubCategory(e.target.value);
            setProductType("");
          }} >
            <option value="">Select Subcategory</option>
              {productTypeOptions[category] &&
              Object.keys(productTypeOptions[category]).map((subCat) => (
        ...
        <div>
          ...
          <select className='w-full px-3 py-2' value={productType}  onChange={(e) => setProductType(e.target.value)}>
            <option value="">Select Type</option>
              {productTypeOptions[category] &&
              productTypeOptions[category][subCategory] &&
              productTypeOptions[category][subCategory].map((type) => (
